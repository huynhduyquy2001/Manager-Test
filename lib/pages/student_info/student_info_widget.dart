...
class _StudentInfoWidgetState extends State<StudentInfoWidget> {
  ...
  void initState() {
    ...
    _model.textController2 ??=
        TextEditingController(text: FFAppState().currentUser.school);
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??=
        TextEditingController(text: FFAppState().currentUser.year.toString());
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '05wmge3p' /* Please enter your information */,
                              ),
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if ((_model.textController1.text != null &&
                                  ...
                                  context.pushNamed('ExamSelectionPage');
                                } else {
